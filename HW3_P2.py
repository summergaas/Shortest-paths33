...
def mstPrim(graph):
    Q = []
    for u in graph[0]:
#        newU = vertex(u.get_data(), u.get_neighbors())
 #       Q.append(newU)
         Q.append(u)
    for u in Q:
...
def getInput():
    d = input("Please place a copy of the test file into the HW3-P2 subfolder and enter its name, using quotations.")
    return d
